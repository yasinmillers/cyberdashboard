    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cyberapp.category')),
                ('stateid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cyberapp.state')),
                ('subcategory_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cyberapp.subcategory')),
            ],
        ),
    ]
